...
{ id:"gastronomia_estadounidense", type:"gastronomia", name:"Gastronomía Estadounidense", x:50, y:55 },
{ id:"aguila_calva", type:"animal", name:"Águila Calva", x:45, y:35 },
{ id:"las_vegas", type:"ciudad", name:"Las Vegas", x:20, y:60 },
{ id:"cactus", type:"planta", name:"Cáctus", x:22, y:70 },
...
{ id:"los_angeles", type:"ciudad", name:"Los Ángeles", x:22, y:65 },
{ id:"hollywood", type:"lugar", name:"Hollywood", x:23, y:66 },
{ id:"parques_california", type:"lugar", name:"Parques temáticos de California", x:24, y:68 },
{ id:"marilyn_monroe", type:"persona", name:"Marilyn Monroe", x:25, y:70 },
{ id:"phoenix", type:"ciudad", name:"Phoenix", x:25, y:72 },
{ id:"gran_canon", type:"naturaleza", name:"Gran Cañón", x:26, y:68 },
...
{ id:"energia_nuclear", type:"energia", name:"Energía Nuclear", x:50, y:45 },
{ id:"dallas", type:"ciudad", name:"Dallas", x:40, y:75 },
{ id:"houston", type:"ciudad", name:"Houston", x:42, y:80 },
{ id:"estacion_espacial", type:"tecnologia", name:"Estación Espacial", x:55, y:30 },
{ id:"viuda_negra", type:"animal_peligroso", name:"Viuda Negra", x:35, y:70 },
{ id:"conejo", type:"animal", name:"Conejo Doméstico", x:48, y:55 },
...
{ id:"policia_montada", type:"cultura", name:"Policía Montada Canadiense", x:58, y:25 },
{ id:"maple", type:"arbol", name:"Árbol de Maple", x:55, y:28 },
...
{ id:"tortuga_galapagos", type:"animal", name:"Tortuga Gigante Galápagos", x:25, y:80 },
{ id:"gastronomia_mexicana", type:"gastronomia", name:"Gastronomía Mexicana", x:45, y:55 },
...
{ id:"angel", type:"lugar", name:"Ángel de la Independencia", x:46, y:55 },
...
{ id:"cdmx", type:"ciudad", name:"Ciudad de México", x:45, y:55 },
...
{ id:"aguila_real", type:"animal", name:"Águila Real", x:50, y:50 },
{ id:"oaxaca", type:"ciudad", name:"Oaxaca", x:48, y:65 },
{ id:"tule", type:"arbol", name:"Árbol del Tule", x:49, y:66 },
...
{ id:"chichen", type:"maravilla", name:"Chichén Itzá", x:65, y:70 },
{ id:"merida", type:"ciudad", name:"Mérida", x:66, y:68 },
{ id:"cancun", type:"ciudad", name:"Cancún", x:70, y:65 },
...
{ id:"panama", type:"ciudad", name:"Ciudad de Panamá", x:50, y:70 },
{ id:"canal_panama", type:"lugar", name:"Canal de Panamá", x:52, y:72 },
{ id:"bolivar", type:"lider", name:"Simón Bolívar", x:55, y:65 },
{ id:"bogota", type:"ciudad", name:"Bogotá", x:56, y:68 },
{ id:"medellin", type:"ciudad", name:"Medellín", x:57, y:70 },
{ id:"caracas", type:"ciudad", name:"Caracas", x:60, y:65 },
{ id:"gabo", type:"artista", name:"Gabriel García Márquez", x:58, y:67 },
{ id:"botero", type:"artista", name:"Fernando Botero", x:57, y:72 },
{ id:"canaima", type:"naturaleza", name:"Parque Nacional Canaima", x:62, y:75 },
{ id:"salto_angel", type:"naturaleza", name:"Salto Ángel", x:63, y:76 },
...
{ id:"vinicunca", type:"naturaleza", name:"Montaña Vinicunca", x:42, y:85 },
{ id:"tayrona", type:"naturaleza", name:"Parque Tayrona", x:60, y:72 },
{ id:"cocora", type:"naturaleza", name:"Valle de Cocora", x:57, y:73 },
{ id:"gastronomia_peru", type:"gastronomia", name:"Gastronomía Peruana", x:46, y:82 },
{ id:"boa", type:"animal_peligroso", name:"Boa", x:58, y:80 },
{ id:"gastronomia_brasil", type:"gastronomia", name:"Gastronomía Brasileña", x:65, y:85 },
...
{ id:"condor", type:"animal", name:"Cóndor", x:30, y:40 },
...
{ id:"amsterdam", type:"ciudad", name:"Ámsterdam", x:46, y:43 },
{ id:"tulipanes", type:"naturaleza", name:"Tulipanes y molinos", x:47, y:44 },

{ id:"pasteur", type:"persona", name:"Louis Pasteur", x:48, y:50 },
{ id:"gastronomia_francesa", type:"gastronomia", name:"Gastronomía Francesa", x:47, y:52 },
...
{ id:"raton", type:"animal", name:"Ratón", x:52, y:62 },

{ id:"torre_eiffel", type:"lugar", name:"Torre Eiffel", x:48, y:53 },
{ id:"paris", type:"ciudad", name:"París", x:48, y:52 },
{ id:"zurich", type:"ciudad", name:"Zurich", x:52, y:50 },

{ id:"milan", type:"ciudad", name:"Milán", x:54, y:57 },
...
{ id:"napoles", type:"ciudad", name:"Nápoles", x:58, y:67 },
...
{ id:"partenon", type:"ruinas", name:"El Partenón", x:61, y:66 },
{ id:"aristoteles", type:"persona", name:"Aristóteles", x:60, y:64 },

{ id:"constantino", type:"persona", name:"Constantino", x:62, y:60 },
{ id:"santa_sofia", type:"religion", name:"Catedral Santa Sofía", x:63, y:61 },
...
{ id:"berlin", type:"ciudad", name:"Berlín", x:52, y:44 },
...
{ id:"moscu", type:"ciudad", name:"Moscú", x:75, y:40 },
...
{ id:"gastronomia_espanola", type:"gastronomia", name:"Gastronomía Española", x:44, y:62 },
...
{ id:"leon", type:"animal", name:"León", x:55, y:60 },
...
{ id:"hipopotamo", type:"animal", name:"Hipopótamo", x:57, y:68 },
...
{ id:"giza", type:"maravilla", name:"Pirámides de Giza", x:46, y:45 },
...
{ id:"oro", type:"industria", name:"Producción de Oro", x:50, y:50 },
...
{ id:"shanghai", type:"ciudad", name:"Shanghái", x:65, y:52 },

{ id:"seul", type:"ciudad", name:"Seúl", x:68, y:48 },
...
{ id:"gastronomia_china", type:"gastronomia", name:"Gastronomía China", x:58, y:60 },
{ id:"gastronomia_japonesa", type:"gastronomia", name:"Gastronomía Japonesa", x:72, y:55 },
{ id:"gastronomia_coreana", type:"gastronomia", name:"Gastronomía Coreana", x:68, y:50 },
...
{ id:"anime", type:"cultura", name:"Animé", x:73, y:53 },

{ id:"kioto", type:"ciudad", name:"Kioto", x:72, y:54 },

{ id:"avispon", type:"animal_peligroso", name:"Avispón Gigante Japonés", x:73, y:52 },
...
{ id:"tiburon", type:"animal_peligroso", name:"Tiburón", x:70, y:70 }
...
function checkMedalUnlock(collectionKey) {
  ...
  if (col.items.size === col.total) {
    ...
    alert("🏅 ¡Medalla desbloqueada! " + col.nombre);
  }
}
